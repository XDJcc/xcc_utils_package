...
import '../extension/network_connect_mixin.dart';

T? _ambiguate<T>(T? value) => value;

abstract class BaseController extends ChangeNotifier with NetworkConnectMixin {
  ...
  ///是否监听网络连接
  bool get observeConnection => false;
